...
# models
from models.BERT_DST_Picklist_adapter import *
from models.dual_encoder_ranking_adapter import *

# adapter-transformers models
...
if args["do_train"]:
    ...
    for run in range(args["nb_runs"]):
        ...
        os.makedirs(args["save_adapter_path"], exist_ok=False)
        ...
        model.utterance_encoder.save_all_adapters(args["save_adapter_path"])
    ...
    if args["load_path"]:
        ...
        logging.info("{}".format(args["load_path"]))
        if torch.cuda.is_available(): 
