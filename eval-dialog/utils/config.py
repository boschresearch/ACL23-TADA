...
parser.add_argument(
    '--model_name_or_path_2', help='', required=False, default="bert", type=str)
parser.add_argument(
    '--model_name_or_path_3', help='', required=False, default=None, type=str)
parser.add_argument(
    '--model_name_or_path_4', help='', required=False, default=None, type=str)
parser.add_argument(
    '--model_name_or_path_5', help='', required=False, default=None, type=str)
parser.add_argument(
    '--model_name_or_path_6', help='', required=False, default=None, type=str)
parser.add_argument(
    '--tokenizer_name_or_path', help='', required=False, default="bert", type=str)
parser.add_argument(
    '--tokenizer_name_or_path_2', help='', required=False, default="bert", type=str)
parser.add_argument(
    '--tokenizer_name_or_path_3', help='', required=False, default=None, type=str)
parser.add_argument(
    '--tokenizer_name_or_path_4', help='', required=False, default=None, type=str)
parser.add_argument(
    '--tokenizer_name_or_path_5', help='', required=False, default=None, type=str)
parser.add_argument(
    '--tokenizer_name_or_path_6', help='', required=False, default=None, type=str)
parser.add_argument(
...
parser.add_argument(
        "--use_average", action='store_true', help="whether to do meta embedding (average)")
parser.add_argument(
        "--use_attention", action='store_true', help="whether to do meta embedding (attention)")
parser.add_argument(
        "--method", default="subword", type=str, help="select one of the following methods for subword aggregation: whitespace, subword, char")
parser.add_argument(
        "--ignore_tod", action='store_true', help="whether to ignore the TOD-BERT representation")
...
parser.add_argument(
        "--domain_option", default="multi", type=str, help="select one of the following domain options for multiwoz: single, multi, full, zero")
parser.add_argument(
