# AdapterTrainer class for pretrained transformer-based model.
# The script is modified from adapter-transformers module.
...
from transformers.file_utils import CONFIG_NAME, WEIGHTS_NAME, is_sagemaker_mp_enabled, logger
...
class AdapterTrainerSelf(TrainerSelf):
    def __init__(
        self,
...
class Seq2SeqAdapterTrainer(AdapterTrainerSelf, Seq2SeqTrainer):
    pass