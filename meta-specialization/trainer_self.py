# Trainer class for pretrained transformer-based model.
...
class TrainerSelf:
    ...
    def train(
        ...
        **kwargs,
        ...
        ##### Here is the testing part for checking the freezed and unfreezed params
        for param in model.named_parameters():
            if param[1].requires_grad==True:
                print("test", param[0], param[1].requires_grad)
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for param in model.named_parameters():
                if param[1].requires_grad==True:
                    print("test", epoch, param[0], param[1].requires_grad)
