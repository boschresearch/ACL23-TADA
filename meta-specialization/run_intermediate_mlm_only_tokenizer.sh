# MLM shell script for domain adaptation via domain-specialized tokenizer.
...
CUDA_VISIBLE_DEVICES=$gpu python run_intermediate_mlm_emb.py \
    ...
    --per_device_train_batch_size=32 --max_seq_length=256 --update_emb_only --update_tokenizer_emb\
    ${add1} ${add2} ${add3}
